...
model = load_model('/data/tdardour_data/image_comp/weights/models_'+str(args.num_neuron)+'n/' + \
                   'fcn_42_AG_'+str(args.num_neuron)+'n/level'+str(args.level)+\
                   '_X1_fcn_42_AG_'+str(args.num_neuron)+'n.h5')
model.summary()
