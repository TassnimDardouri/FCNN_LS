...
if args.Loss == 'L_beta' or args.Loss ==  'sum_log_L_beta_adapt' or args.Loss == 'log_L_beta_adapt':
    ...
    train_generator = generator_beta(x_set = train_list, beta = beta_train[:,((args.level-1)*3)+1])
    test_generator = generator_beta(x_set = test_list, beta = beta_test[:,((args.level-1)*3)+1])
else:
