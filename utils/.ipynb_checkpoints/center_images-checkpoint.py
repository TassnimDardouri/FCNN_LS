...
if __name__ == '__main__':
    ...
    pool = Pool(30)
    dir_train = '/data/tdardour_data/datasets/clic/ordered_clic_train_dataset/'
    dir_val = '/data/tdardour_data/datasets/clic/ordered_clic_valid_dataset/'
    dir_test = '/data/tdardour_data/datasets/clic/ordered_clic_test_dataset/'
