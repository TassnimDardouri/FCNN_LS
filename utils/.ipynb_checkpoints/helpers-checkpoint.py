...
def get_args():
    ...
    parser.add_argument('--val_path', type=str, default='/data/tdardour_data/datasets/clic/ordered_clic_test_dataset', 
                        help='')
    ...
    parser.add_argument('--beta_p1', type=str, default='0.6', help='0.62,0.62,0.72,0.57,0.57,0.63,0.54,0.54,0.56')
    parser.add_argument('--beta_p2', type=str, default='0.6', help='0.62,0.62,0.72,0.57,0.57,0.63,0.54,0.54,0.56')
    parser.add_argument('--beta_p3', type=str, default='0.6', help='0.62,0.62,0.72,0.57,0.57,0.63,0.54,0.54,0.56')
