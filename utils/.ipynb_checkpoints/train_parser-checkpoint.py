...
class Options():
    def __init__(self, trans = '42_AG', method = 'fcn_42_AG_clic', level = 1, 
        ...
        self.save_models_path = '/data/tasnim/weights/models_%sn/%s'%(num_neuron, method)
        self.save_reference_path = '/data/tasnim/references/%s'%(method)
        ...
        if self.level == 1:
            self.im_path_train = '/data/tasnim/datasets/clic/centered_ordered_clic_train_dataset'
            self.im_path_test = '/data/tasnim/datasets/clic/centered_ordered_clic_valid_dataset'
